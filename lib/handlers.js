 ...
 handlers.index = (data, callback) => {
    ...
    if(data.method == 'get') {
        ...
        var templateData = {
            ...
            'head.description': 'This is a free simple uptime monitoring for http and https sites. When your site goes down, we will send you an SMS',
 ...
 handlers.accountCreate = (data, callback) => {
    ...
    if(data.method == 'get') {
        ...
        var templateData = {
            ...
            'head.description': 'Easy signup, takes a few seconds',
